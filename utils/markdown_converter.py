...
def markdown_to_html(text: str) -> str:
    """
    Convert basic markdown to HTML for display in analyse_chat_2 bubbles. It handles text formatting,
    ...
    for line in lines:
        ...
        # Check for numbered lists (1., 2., 3., etc.)
            ...
            if stripped_line and not (
                    stripped_line.startswith('• ') or stripped_line.startswith('- ') or re.match(r'^\d+\.\s',
                                                                                                 stripped_line)):
