...
Revision ID: 80b5de728fde
Revises: 
Create Date: 2026-07-05 16:51:44.024982
...
def upgrade() -> None:
    ...
    sa.Column('home_location', sa.String(length=100), nullable=False),
    sa.Column('plant_location', sa.String(length=100), nullable=False),
