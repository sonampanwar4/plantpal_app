...
class AILog(Base):
    ...
    chat_type = Column(String(50), CheckConstraint("type IN ('chat', 'diagnosis')"))
    ...
    ai_responses = relationship("AIResponse", uselist=False, back_populates="ai_log", cascade="all, delete")
